...
user_info["favourite_meals"][0],user_info["favourite_meals"][-1]=user_info["favourite_meals"][-1],user_info["favourite_meals"][0]  # 7. elemek felcserelese
#print(user_info["favourite_meals"])
...
user_info["phone_contacts"]["Tim"]=user_info["phone_contacts"].pop("Tim2",None) # +2 Tim atnevezese
#print(user_info["phone_contacts"])