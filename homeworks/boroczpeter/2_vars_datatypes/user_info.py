...
print("------------------------")
print("" "")
pprint(user_info) #full data print as requested in tipp
...
#9. delete Tom and his phone number from phone_conatcts
del user_info["phone_contacts"]["Tim"]

#10. ad a user with 2 phone number
...
print("------------------------")
print()
print("Summary:") #printed a summary of the homework
print()
pprint(user_info)